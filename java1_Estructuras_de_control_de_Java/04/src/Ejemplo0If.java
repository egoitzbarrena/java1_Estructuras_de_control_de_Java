...
//recoje lo que has introducido en la variable nota.
        int nota = sc.nextInt();
// si la nota es mayor o igual a 5 , se ejecutan los siguientes dos lineas. si no se cumple la condicion aparece otra linea (else). 
        if (nota >= 5 ){
...
//pinta en la pantalla un texto. en este caso la frase Lo Siento, has suspendido.
