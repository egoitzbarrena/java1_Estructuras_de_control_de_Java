 ...
 */
//definición de la clase Ejemplo3While
...
//mientras el valor de la variable fahrenheit sea menor o igual a la de la variable VALOR_FINAL se ejecutaran las siguientes lineas.
        while (fahrenheit <= VALOR_FINAL ){
//calcula la operacion que esta en la izquierda y pasa el valor a la variable celcius.
               celsius = 5*(fahrenheit - 32)/9.0;
//pinta en la pantalla un texto. en este aparece la siguiente linea. . 
               System.out.printf("%7d \t %8.3f \n", fahrenheit, celsius);
//le sumo el valor de la variable PASO a la variable fahrenheit.
               fahrenheit += PASO;
        }
    }
}
